    ...
    [
        dbc.Button(
           "Reactor Conditions",
            ...
            className='mb-3',
            block=True, #extends button to full width of container
            style=BUTTON_STYLE,
        ),
        dbc.Collapse(
...
APC_info_card = dbc.Card(
    html.Div(
        [
            dbc.CardImg(src="https://i.postimg.cc/HktyPdSc/APC-logo.jpg", top=True,
                        style={'height': '65%', 'width': '65%'}),
            dbc.CardBody(
                [
                html.P("To find out more about APC's kinetic modelling capabilities, visit the link below", className="card-text"),
...
@app.callback(
    dash.dependencies.Output(component_id='collapse_body_KineticParameters', component_property='is_open'),
    [dash.dependencies.Input(component_id='Collapse_button_KineticParameters', component_property='n_clicks')],
    [dash.dependencies.State(component_id='collapse_body_KineticParameters', component_property='is_open')],
)
...
@app.callback(
    dash.dependencies.Output(component_id='collapse_body_RXNCondition', component_property='is_open'),
    [dash.dependencies.Input(component_id='Collapse_button_RXNCondition', component_property='n_clicks')],
    [dash.dependencies.State(component_id='collapse_body_RXNCondition', component_property='is_open')],
)
...
@app.callback(
    dash.dependencies.Output(component_id='collapse_body_RXNOrders', component_property='is_open'),
    [dash.dependencies.Input(component_id='Collapse_button_RXNCOrders', component_property='n_clicks')],
    [dash.dependencies.State(component_id='collapse_body_RXNOrders', component_property='is_open')],
)
def toggle_collapse(n, is_open):
    if n:
        return not is_open
...
@app.callback(
    dash.dependencies.Output(component_id='collapse_body_Table', component_property='is_open'),
    [dash.dependencies.Input(component_id='Collapse_button_Table', component_property='n_clicks')],
    [dash.dependencies.State(component_id='collapse_body_Table', component_property='is_open')],
)
def toggle_collapse(n, is_open):
    if n:
        return not is_open
...
@app.callback(
    dash.dependencies.Output(component_id='PreExpslider-output-container', component_property='children'),
    [dash.dependencies.Input(component_id='PreExpSlider', component_property='value')])
def UpdatePreExpSlider(value):
    transfromedvalue = 10 ** value
    return 'You have selected "{}" mol/L s'.format(transfromedvalue)

@app.callback(
    dash.dependencies.Output(component_id='Easlider-output-container', component_property='children'),
    [dash.dependencies.Input(component_id='EaSlider', component_property='value')])
def UpdateEaSlider(value):
    return 'You have selected "{}" kJ/mol'.format(value)

@app.callback(
    dash.dependencies.Output(component_id='kineticgraph', component_property='figure'),
    dash.dependencies.Output(component_id='ResultsTable', component_property='data'),
    dash.dependencies.Input(component_id='UpdateButton', component_property='n_clicks'),
    dash.dependencies.State(component_id='InitialConcA', component_property='value'),
    dash.dependencies.State(component_id='InitialConcB', component_property='value'),
    dash.dependencies.State(component_id='InitialConcC', component_property='value'),
    dash.dependencies.State(component_id='InitialConcD', component_property='value'),
    dash.dependencies.State(component_id='RXRTEMP', component_property='value'),
    dash.dependencies.State(component_id='TotalTime', component_property='value'),
    dash.dependencies.State(component_id='RXNOrderA', component_property='value'),
    dash.dependencies.State(component_id='RXNOrderB', component_property='value'),
    dash.dependencies.State(component_id='PreExpSlider', component_property='value'),
    dash.dependencies.State(component_id='EaSlider', component_property='value'),
    dash.dependencies.State(component_id='PlotCheckBoxes', component_property='value'),
)
...
@app.callback(
    ...
    dash.dependencies.Input(component_id="DownLoadButton", component_property="n_clicks"),
    dash.dependencies.State(component_id='InitialConcA', component_property='value'),
    dash.dependencies.State(component_id='InitialConcB', component_property='value'),
    dash.dependencies.State(component_id='InitialConcC', component_property='value'),
    dash.dependencies.State(component_id='InitialConcD', component_property='value'),
